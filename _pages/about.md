...
I am a **researcher in systems and computational neuroscience**. I believe that to prevent [random-walk science](https://www.thetransmitter.org/theoretical-neuroscience/breaking-the-barrier-between-theorists-and-experimentalists), ideas derived from theory and experiments must be discussed in the same tight teams, not just the same universities. My research combines experimental (electrophysiology, optogenetics, and rodent behaviour) with computational (biophysical modeling, dynamical systems, deep learning) techniques. By bridging these domains, I hope to help shed light on how neural circuits give rise to behaviour and cognition. I am also convinced that modern neuroscience projects have outgrown reasonable individuals workloads and must be done collaboratively. Which also makes it way more fun!

Currently, I am studying context-dependent decision-making in the [Brody lab](https://brodylab.org). Some of my work:
...
- [NeuroPyxels](https://github.com/m-beau/NeuroPyxels), a generalist Python package to analyze [Neuropixels](https://www.nature.com/articles/nature24636) data, and [PixelMap](https://github.com/m-beau/channelmap_generator), a browser-based GUI to generate Neuropixels channelmaps (.imro files).
...
**In my free time**, I practice and teach Shotokan Karate (2nd Dan black belt, FFKDA), and the rest of the time mostly cook/brew espresso for friends.
